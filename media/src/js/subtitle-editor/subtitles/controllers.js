...
(function() {
    ...
    module.controller('WorkingSubtitlesController', ["$scope", "DomWindow", "$filter", "VideoPlayer", "Keys", "SubtitleSoftLimits", function($scope, DomWindow, $filter, VideoPlayer, Keys, SubtitleSoftLimits) {
        /**
